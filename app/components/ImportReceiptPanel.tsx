...
import { X, Loader2, ClipboardPaste, FileText, Camera, Trash2, Plus } from 'lucide-react';
            ...
            <div>
              ...
              <div className="space-y-1 max-h-[200px] overflow-y-auto">
                {parsedItems.map((item, idx) => (
                  <div key={idx} className="flex gap-1 items-center bg-slate-50 dark:bg-slate-800 rounded p-1.5 [dir=rtl]:flex-row-reverse">
                    <Input
                      value={item.name}
